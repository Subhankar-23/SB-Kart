...
if(mysqli_num_rows($result)>0)    
{
    ...
    while($row= mysqli_fetch_array($result))
    {
        ...
        echo "<div class='box'>";
        echo "<div class='row'><div class='col-sm-12'><a href='Camera_desp.php?pid=$row[0]'><img src='$row[4]' width='260px' height='150px' /></a></div></div>";
        ...
        echo "<div class='row'><div class='col-sm-12'><a href='Camera_desp.php?pid=$row[0]'><input type='submit' name='desp'  value='Buy Now' /></a></div></div>";
        echo "</div>";
        echo "</div>";
        $x++;
        if($x==4)
