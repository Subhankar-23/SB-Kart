...
if(mysqli_num_rows($result)>0)    
{
    ...
    echo "<div class='col-sm-3'></div>";
        ...
        echo "<div class='box'>";
        echo "<div class='row'><div class='col-sm-12'><a href='Camera.php'><img src='$row[4]' width='180px' height='150px' /></a></div></div>";
        ...
        echo "<div class='col-sm-2'>";
        echo "<div class='box'>";
        echo "<div class='row'><div class='col-sm-12'><a href='Camera.php'><img src='$row1[4]' width='180px' height='150px' /></a></div></div>";
        ...
        echo "<div class='col-sm-2'>";
        echo "<div class='box'>";
        echo "<div class='row'><div class='col-sm-12'><a href='Camera.php'><img src='$row2[4]' width='180px' height='150px' /></a></div></div>";
