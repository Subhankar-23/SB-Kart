...
<html>
<head>
	<title>Camera Description | SB Kart</title>
...
if(mysqli_num_rows($result)>0)            //Display Tab
{
	...
	echo "<div class='col-sm-6'>
			...
			<div class='row'>
			<a href='orderC.php?pid=$pid'><div class='col-sm-12'><br><br><input type='button' name='buy' style='width:30%;font-weight: bold;' class='btn btn-success' value='Buy Now' /></a>     
			<a href='mycart_logic.php?pid=$pid&page=Camera_desp'><input type='button' name='add' style='width:30%;font-weight: bold; background-color:#a5bee6;' class='btn' value='Add to Cart' /></a>
			</div></div>
		</div>";
	echo "<div class='col-sm-1'></div>";
	echo "</div>";
...
$qry="select * from camera_specifications where p_id='$pid'";
...
if(mysqli_num_rows($result)>0)     //Specification Table     
 {
	...
	echo "<div class='col-sm-4' >Brand</div>";
	...
	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Battery Type</div>";
	echo "<div class='col-sm-6' >$row[4]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Self-Timer</div>";
	echo "<div class='col-sm-6' >$row[5]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Image-Type</div>";
	echo "<div class='col-sm-6' >$row[6]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Aspect Ratio</div>";
