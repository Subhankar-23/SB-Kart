...
<html>
<head>
	<title>Laptop Description | SB Kart</title>
...
if(mysqli_num_rows($result)>0)            //Display Tab
{
	...
	echo "<div class='col-sm-3'><img src='$row[4]' width='300px' height='250px' title='$row[0]' /></div>";
	echo "<div class='col-sm-1'></div>";
	echo "<div class='col-sm-6'>
			...
			<div class='row'>
			<div class='col-sm-12'>
			<font style='color: black; font-size:15px;'>Buy Now to get maximum <b style='color: red;'>20% cashback</b></font>
			<br><br><div class='price' style='color:blue;font-size:25px;'>Price: <span>&#8377;</span>$row[2]</div>
			</div></div>
			<div class='row'>
			<a href='order.php?pid=$pid'><div class='col-sm-12'><br><br><input type='button' name='buy' style='width:30%;font-weight: bold;' class='btn btn-success' value='Buy Now' /></a>     
			<a href='mycart_logic.php?pid=$pid&page=Laptop_desp'><input type='button' name='buy' style='width:30%;font-weight: bold; background-color:#a5bee6;' class='btn' value='Add to Cart' /></a>
			</div></div>
		</div>";
	echo "<div class='col-sm-1'></div>";
	echo "</div>";
...
if(mysqli_num_rows($result)>0)     //Specification Table     
 {
	...
	echo "<div class='col-sm-4' >Processor Name</div>";
	echo "<div class='col-sm-6' >$row[1]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Processor Brand</div>";
	echo "<div class='col-sm-6' >$row[2]</div>";
	echo "</div>";	

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Processor Gen</div>";
	echo "<div class='col-sm-6' >$row[3]</div>";
	echo "</div>";	

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >SSD</div>";
	...
	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >HDD</div>";
	echo "<div class='col-sm-6' >$row[6]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Graphics Processor</div>";
	echo "<div class='col-sm-6' >$row[7]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >OS Arch</div>";
	...
	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Touch Screen</div>";
	echo "<div class='col-sm-6' >$row[11]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Screen Size</div>";
	echo "<div class='col-sm-6' >$row[12]</div>";
	echo "</div>";

	echo "<div class='row' style='font-size: 15px; padding-top:18px;'>";
	echo "<div class='col-sm-4' >Warranty</div>";
